$(document).ready(function () {
	...
	$(".stars-example-fontawesome-o .current-rating").find("span").html(e), $(".stars-example-fontawesome-o .clear-rating").on("click", function (e) {
		...
		onSelect: function (e, a) {
			e ? ($(".stars-example-fontawesome-o .current-rating").addClass("hidden"), $(".stars-example-fontawesome-o .your-rating").removeClass("hidden").find("span").html(e)) : $("#rating-current-fontawesome-o").barrating("clear")
		},
