<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MinibleV2.Master" CodeBehind="testRES.aspx.vb" Inherits="Dashboard.testRES" %>
...
<div class="dropdown mb-3">
    ...
    <asp:CheckBox ID="chkAllColumns" runat="server" AutoPostBack="true" OnCheckedChanged="chkAllColumns_CheckedChanged" />
    <label class="form-check-label fw-bold text-primary" for="<%= chkAllColumns.ClientID %>">
        แสดงทั้งหมด
    </label>
</div>
